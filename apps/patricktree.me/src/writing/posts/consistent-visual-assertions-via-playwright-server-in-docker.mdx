...
You can take a look at <FancyAnchor href="https://github.com/patricktree/playwright-server-docker-visual-testing-example">`playwright-server-docker-visual-testing-example`</FancyAnchor> for a full example of wiring this up automatically.
