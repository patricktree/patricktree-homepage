...
giscusTerm: testing-package-consumption-scenarios
---
...
You can see several examples of such scenarios in <FancyAnchor href="https://github.com/patricktree/pkg-consumption-test/tree/main/pkg-consumption-test/examples/typescript-eslint-rules-requiring-type-info">this repository</FancyAnchor>.
