...
import { MDXContentClientComponent } from '#pkg/app/(site)/blog/testing-package-consumption-scenarios/mdx-content-client-component.jsx';
import styles from '#pkg/app/(site)/blog/testing-package-consumption-scenarios/styles.module.css';
