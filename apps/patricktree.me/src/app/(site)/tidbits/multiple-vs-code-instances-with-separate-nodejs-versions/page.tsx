...
import { MDXContentClientComponent } from '#pkg/app/(site)/tidbits/multiple-vs-code-instances-with-separate-nodejs-versions/mdx-content-client-component.jsx';
import styles from '#pkg/app/(site)/tidbits/multiple-vs-code-instances-with-separate-nodejs-versions/styles.module.css';
