/* config.ts is the only place where reading from process.env is allowed */
/* this file is consumed by the web app and access to "windows" explicitely is on purpose */
